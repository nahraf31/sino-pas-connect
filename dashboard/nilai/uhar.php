...
<!DOCTYPE html>
  <html>
    <head>
		  <title><?php echo $nama_siswa; ?> - UHAR</title>
	...
	<body>
		...
		<nav>
			<div class="nav-wrapper">
				...
				<ul class="side-nav" id="mobile-demo">
					...
					<li><a href="../">Home</a></li>
					<li class="active"><a href="uhar.php">Ulangan Harian</a></li>
		...
		<main>
			<div class="container">
				<div class="row">
					<div class="col s7">
						<h1 class="judul-halaman">Ulangan Harian</h1>
					</div>
					<div class="col s5">
						...
						<div class="col s12" style="text-align:center">
							...
							?>			
										<div class="nilai tidak-lulus">
											<div class="rate" data-count="<?php echo $row['nilai']; ?>"></div>
											<span>UH <?php echo $row['nama_pelajaran']; ?> <?php echo $i; ?></span>
										</div>
							<?php 		
										} 
