...
<head>
    ...
    <title>Nilai UAS Semester 4 - <?php echo $nama_siswa; ?></title>
				...
				<ul class="nav menu-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="../settings"><i class="material-icons">settings</i>Pengaturan</a></li>
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
				  ...
				  <li><a href="#">UAS</a></li>
				  <li class="active"><a href="uas_4.php">Semester 4</a></li>
				</ol>
				<h1>Nilai UAS</h1>
			...
			<div class="col-md-9">
				<nav>
				  <ul class="pagination">
					...
					<li class="active"><a href="uas_4.php">4</a></li>
