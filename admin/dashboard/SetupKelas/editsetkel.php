<?php
	...
	$id=$_GET['id'];
	$res=$pdo->query("SELECT * FROM setup_kelas WHERE id_kelas='$id'");
...
<html>
	<head>
		<title>Edit Kelas - <?php echo $row['nama_admin']; ?> </title>
    ...
    <body>
		...
		<div class="side-nav fixed">
			<div class="logo">
				...
				<li class="active"><a href="../SetupKelas/">Setup Kelas &rarr; Edit</a></li>
				...
				<div class="col s12">
					...
					<div class="row">
						<form class="col s12" action="../SetupKelas/" method="post" name="edit">
							<input value="<?php echo $bow['id_kelas']; ?>" type="hidden" name="id_lama">
							<div class="input-field col s12">
								<input value="<?php echo $bow['nama_kelas']; ?>" id="first_name2" type="text" name="nama">
								<label class="active" for="first_name2">Nama Kelas</label>
							</div>
							<div class="input-field col s12">
								<input value="<?php echo $bow['id_kelas']; ?>" id="first_name2" type="text" name="id">
								<label class="active" for="first_name2">ID Kelas</label>
							</div>
							<button class="btn waves-effect waves-light" href="setup_kelas.php">Back
							</button>
